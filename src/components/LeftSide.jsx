...
import { addTask, deleteTask, toggleComplete, setTasks } from '../redux/taskSlice';
    ...
    return (
        ...
        <section className="task-add">
            ...
            <form id="addTaskForm" onSubmit={handleAddTask}>
                <fieldset>
                    <legend>Name</legend>
                    <input type="text" id="taskTitle" placeholder="Name of task" value={taskTitle} onChange={(e) => setTaskTitle(e.target.value)}/>
                </fieldset>

                <fieldset>
                    <legend>Description</legend>
                    <input id="taskDescription" placeholder="Description" value={taskDescription} onChange={(e) => setTaskDescription(e.target.value)}/>
                </fieldset>
